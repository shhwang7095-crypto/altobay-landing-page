    ...
    >
      <div>
        <div className="mx-auto max-w-xl rounded-2xl border border-dashed border-brand-blue/40 bg-brand-blue/5 px-5 py-4 text-sm text-muted-foreground">
          <strong className="text-foreground">How to try it:</strong> use the dark bar at the
          top of the screen below to jump between steps — Jobs → Scope → Before → Work → After →
          Read → Review → Done. Tap a car, tick what to check, shoot before/after photos, then
          watch AI read them into a report you can edit and send.
        </div>
